...
- current effective sampling range: `x=[0.26,0.40]`, `y=[0.05,0.15]`
- current item/bin minimum center distance: `0.135m`
- current item/bin bin-footprint exclusion margin: `0.02m`
- current reward route: v35 stable pre-grasp shaping with stronger spacing plus small action-smoothness penalties
- current recommended experiment: train v35 fresh; do not resume older checkpoints because the action distribution, sampling range/spacing/exclusion, and reward changed
